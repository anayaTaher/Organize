...
export default function SignUp() {
  ...
  const signUpWithGoogle = () => {
    ...
    auth
      ...
      .then((cred) => saveAdditionalInfoToFirebaseAndMongoDB(cred, true));
  };
          ...
          <Dialog open={open2}>
            ...
            <DialogContent>
              <DialogContentText>
                ...
                <p>
                  These terms and conditions set forth the general terms and
                  conditions of your use of this website and any of its related
                  products and services. This Agreement is legally binding
                  between you and this Website operator. If you are entering
                  into this agreement on behalf of a business or other legal
                  entity, you represent that you have the authority to bind such
                  entity to this agreement. If you do not have such authority,
                ...
                <p>
                  ...
                  to use of all submitted Content. We may, but have no
                  obligation to, monitor and review the Content on the Website
